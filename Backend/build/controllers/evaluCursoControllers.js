...
class EvaluCursoControllers {
    createEvaluCurso(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            yield database_1.default.query('INSERT INTO evaluacioncurso set ?', [req.body]);
    ...
    getEvaluCurso(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            const { id } = req.params;
            console.log(id);
            const curso = yield database_1.default.query('SELECT * FROM evaluacioncurso WHERE idCurso = ?', [id], function (error, results, fields) {
                if (error)
                    throw error;
                res.json(results);
            });
